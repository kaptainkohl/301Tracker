var bingoList = [];
bingoList[1] = [
{name: "All Honeycomb in IoH", types: ["Honeycombs", "IoH"]},
{name: "All Notes in MT", types: ["Notes", "MT", "Trebleclef"]},
{name: "6-Health BK", types: ["Honeycombs", "IoH"]},
{name: "Purchase Blubber’s Last Possesion", types: ["JRL"]}
];
...
{name: "Get Double Air", types: ["Moves", “JRL”, "IoH"]},
...
{name: "30 Doubloons", types: ["Doubloons", "JRL"]},
...
{name: “3 Boss Jiggies”, types: [“Jiggies”, “Boss”]},
...
{name: "Oil Drill Jiggy w/o Shack Pack", types: ["Jiggies", "HFP", "GI"]},
{name: "Boggy’s Kids Jiggy", types: ["Jiggies", "WW", "TDL"]},
{name: “All Train Switches”, types: [“Train”]},
{name: “Hatch Heggy’s 3 Eggs”, types: [“SoS”]}
];
...
{name: "QC Barrels Jiggy from far side", types: ["Jiggies", "GI"]},
{name: "Dragon Kazooie", types: ["SoS", "IoH", "GGM", "MT"]},
{name: “4 Boss Jiggies”, types: [“Jiggies”, “Boss”,]},
...
{name: "Terry’s Kids Jiggy", types:["Jiggies", "TDL", "Bosses"]},
...
bingoList[23] = [
{name: "Worker Jiggy in GI", types: ["Jiggies", "GI", "WW"]},
