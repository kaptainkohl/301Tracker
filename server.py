...
def display_counts():
		...
		while quit:
			...
			for x in range(0,len(user_data)):
				...
				cv2.putText(canvas,"Game "+str(current_game)+"/3",(55,45+x*125), font, 0.4,(255,255,255),1)	
				cv2.putText(canvas,"Place: "+str(current_place),(140,45+x*125), font, 0.4,(255,255,255),1)				
