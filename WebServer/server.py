...
user_name = ["Connor75","Emoarbiter","ObiyoSRL","Secrethumorman","Dickhiskhan","icupspeedruns_","Hagginater","ElectricFortune","kaptainkohl","HolySanctum","Mittenz","PurpleRupees","Hagginatersd"]
user_pic = []
totals=''
y =0
a =0
